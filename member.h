 ...
 * 
 * @param member - The member which we want a copy of.
 * @return
 ...
 * 
 * @param member - The member which we want to free.
 */
 ...
 * 
 * @param member1 - The first member which we want in the comparison.
 * @param member2 - The second member which we want in the comparison.
 * @return
 ...
 * 
 * @param member_priority - The ID which we want to copy.
 * @return
 ...
 * 
 * @param member_priority - the ID which we want to free.
 */
 ...
 * 
 * @param member_priority1 - The first ID which we want in the comparison. 
 * @param member_priority2 - The second ID which we want in the comparison.
 * @return  
...
/**
 * @brief Gets a PQElementPriority, copies it into an int variable and returns it.
 * 
 * @param n - The PQElementPriority which we want to copy as an Integer. 
 * @return 
 ...
 * 
 * @param n - The PQElemenPriority which we want to free. 
 */
 ...
 * 
 * @param n1 - The first int which we want in the comparison
 * @param n2  -The second int which we want in the comparison.
 * @return
 ...
 * 
 * @param member - The Member which we want to get his name.
 * @return 
 ...
 * 
 * @param member - The member which we want to change his name.
 * @param member_name - The new name for the given member.
 */
void setMemberName(Member member, char* member_name);

/**
 * @brief Returns the number of events which the given member is linked to.
 * 
 * @param member - The Member which we want to get his number of linked events. 
 * @return 
...
/**
 * @brief Returns a pointer to the number of events which the given member is linked to.
 * 
 * @param member - The member which we want to get a pointer to his number of linked events  
 * @return 
...
/**
 * @brief Sets the number of events which the given member is linked to, to a new value.
 * 
 * @param member - The member which we want to change his number of linked events. 
 * @param new_num_of_events - The new number of events which we want to assign to the member.
 */
 ...
 * 
 * @param member - The member which we want to get his ID. 
 * @return
 *   NULL - If member is NULL.
 ...
 * 
 * @param member - The member which we want to increase his linked number of events. 
 */
 ...
 * 
 * @param member - The member which we want to decrease his linked number of events. 
 */
